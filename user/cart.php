...
if(isset($_SESSION['newOrder'])){
    ...
    (isset($_SESSION['newOrder'][0]['sum']))? $somme + $livraison : 0 ;
    ...
    $id = $_SESSION['newOrder'][0]['id_customer'];
}
// var_dump($_SESSION);
...
<div class="container-fluid m-3 ">
    <div class="row justify-content-center align-items-center">
        <div class="col-6 p-5 border">
            <h5 text-center>Commande <?= $_SESSION['newOrder'][0]['lastname'] . ' '.  $_SESSION['newOrder'][0]['firstname'] ?></h5>
            <!-- table -->
            <table class="table table-hover">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td><strong><em>Total: </em></strong><?= $somme + $livraison ?> €</td>
                    </tr>
                </tfoot>
            </table>
        </div>
        ...
        <?php if(isset($_SESSION['newOrder'][0]['payment'])): ?>
            <div class="d-flex">
                <form method="POST">
                    ...
                    <input type="hidden" class="form-control" name="sum" value="<?= (isset($_SESSION['newOrder'][0]['sum']))? $somme + $livraison : 0 ; ?>">
                    <div class="mb-3">
